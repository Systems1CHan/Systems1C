    ...
    <body>
        ...
        <main>
            ...
            <div class="sample-area">
                ...
                <div id="tabbody">
                    <div id="tabpage1">
						<div class="subTitle">契約内容照会確認(契約条件タブ)(法人)</div>
						<table border="1" style="border-collapse: collapse">
  							...
  							<tr>
   								 <td>会社名-カナ</td><td><c:out value="${requestScope.contractInfo.getkanaNameForLabel()}"/></td>
  							</tr>
  							 <tr>
   								 <td>会社名-漢字</td><td><c:out value="${requestScope.contractInfo.getNameForLabel()}"/></td>
  							</tr>
  							 <tr>
