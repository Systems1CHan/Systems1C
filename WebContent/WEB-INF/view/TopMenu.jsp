...
<body>
	...
	<main>
		<article>
			<button type="button" onclick="toLogin();" class="button_design_logout">ログアウト（仮）</button>

			<div class="roundedConer">
				<div class="subTitle">TOPメニュー</div>
				<div class="button_center">
					<button type="button" onclick="toA();" class="button_design">新規試算</button>
				</div>
				<div class="button_center">
					<button type="button" onclick="toB();" class="button_design">計上</button>
				</div>
				<div class="button_center">
					<button type="button" onclick="toC();" class="button_design">契約内容照会</button>
				</div>
				<div class="button_center">
					<button type="button" onclick="toD();" class="button_design">解約</button>
				</div>
				<div class="button_center">
					<button type="button" onclick="toE();" class="button_design_last">事故受付</button>
				</div>
			</div>
		</article>
	</main>
