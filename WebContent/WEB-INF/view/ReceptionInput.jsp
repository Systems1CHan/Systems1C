...
--------------------------------------------------------------------------------------------
修正履歴（修正日：担当者：修正内容）
(2022/09/20 ： NarimichiHenmi/SYS ：CSSの追加とクライアントエラーの実装のため、一部変更。)
-------------------------------------------------------------------------------------------->
						...
						<table class="form_table">
							...
							<tr>
								...
								<td><input type="text" placeholder="相手にケガはなし"
									id="accidentsituation" name="accidentsituation"
							...
							<tr>
								...
								<td><input type="text" placeholder="A0000001"
									id="damagecarprice" name="damagecarprice"
							...
							<tr>
								...
								<td><input type="text" placeholder="一部あり"
									id="damagecarstate" name="damagecarstate"
							...
							<tr>
								...
								<td><input type="text" placeholder="A0000001"
									id="damagebodilyprice" name="damagebodilyprice"
							...
							<tr>
								...
								<td><input type="text" placeholder="なし"
									id="damagebodilystate" name="damagebodilystate"
