	...
	<main>
		<form action="" id="@@@@@@@@@" method="post">
			...
			<div class="sample-area">
				...
				<div id="tabbody">
					<div id="tabpage1">
						<p class="main_subTitle">契約内容照会確認(契約条件タブ)</p>
						<table class="confirm_table" border="1"
							...
							<tr>
								<td class="confirm_table_left">払込回数</td>
								<td><c:out
										value="${requestScope.contractInfo.getInstallment()}" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><c:out
										value="${requestScope.contractInfo.getGenderForLabel()}" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><c:out
										value="${requestScope.contractInfo.getBirthdayForLabel()}" /></td>
							</tr>
							<tr>
					...
					<div id="tabpage2">
						<p class="main_subTitle">契約内容照会確認(補償タブ)</p>
						<table class="confirm_table" border="1"
							style="border-collapse: collapse" class="width_all">
							<tr>
								<td class="confirm_table_headline" colspan="2">契約内容照会確認</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><fmt:formatNumber
										value="${requestScope.compensation.getVehiclePrice()}" />万円</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><fmt:formatNumber
										value="${requestScope.compensation.getPremiumInstallment()}" />円</td>
							</tr>
						</table>
					</div>
				</div>
